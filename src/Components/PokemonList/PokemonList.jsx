...
function PokemonList() {
  ...
  async function DownloadPokemons() {
    setIsLoading(true) // on clicking prev and next name and image appear together
    const response = await axios.get(pokedexURL); //we get list of first 20 pokemons in which we get their names and the URLs from which we can bring those pokemon
